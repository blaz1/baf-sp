        ...
        <form id="createBetForm">
            <div class="column floatLeft">
                <div class="row">
                    ...
                    <div class="col2"><input size="39" placeholder="Name" id="newFormName" name="betName"></div>
                </div>
                <div class="row desc">
                    <div class="col1"><label>Description: </label><br></div>
                    <div class="col2"><textarea rows="5" cols="30" placeholder="Enter description" id="newFormDesc" name="betDesc"></textarea></div>
                </div>
                <div class="row">
                    <div class="col1"><label>Start time: </label><br></div>
                    <div class="col2"><input type="date" size="39" placeholder="yyyy-mm-dd" id="newFormStart" name="betStart"></div>
                </div>
                <div class="row">
            ...
            <input type="submit" id="createBetButton" value="Create">              
        </form>
    </div>
</body>
</html>